...
def res():
    ...
    while webcam1.isOpened():
        ...
        bbox1,label1,conf1=cv.detect_common_objects(frame1)

        status2,frame2=webcam2.read()
        bbox2,label2,conf2=cv.detect_common_objects(frame2)

        status3,frame3=webcam2.read()
        bbox3,label3,conf3=cv.detect_common_objects(frame3)
